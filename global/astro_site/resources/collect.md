...
## STRICT RULES
- MUST read `specs/astro_site/parameters.md`
...
2. Load parameters from `specs/astro_site/parameters.md` and parse the single "Context" field (free-form text). From it, extract:
